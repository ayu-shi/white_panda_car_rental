...
let BookCarComponent = class BookCarComponent {
...
BookCarComponent.ctorParameters = () => [
...
let CarGetComponent = class CarGetComponent {
    constructor(bs) {
        this.bs = bs;
    }
    ngOnInit() {
...
CarGetComponent.ctorParameters = () => [
    { type: _business_service__WEBPACK_IMPORTED_MODULE_2__["BusinessService"] }
];
...
let InfoUpdateDeleteComponent = class InfoUpdateDeleteComponent {
    constructor(bs, router) {
        this.bs = bs;
        this.router = router;
    }
...
InfoUpdateDeleteComponent.ctorParameters = () => [
    { type: _business_service__WEBPACK_IMPORTED_MODULE_2__["BusinessService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
